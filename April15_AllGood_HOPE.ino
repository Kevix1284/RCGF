...
//For Forward Movement (Duty Cycle)
#define CH5 5         //MainMotorController                 Forward Speed Control
#define CH7 7         //SSR Enable Switch                   Forward Enable Control
...
bool EngineEnable;
  ...
  Serial.print("DutyCycle Value is: ");
  Serial.print(voltage);
  Serial.println();
  digitalWrite(7, EngineEnable);
  Serial.print("EngineEnable is: ");
